...
#   debug print flag
# BASE_DIR:
#   pacakge base directory that is ending in the name 'debian.'
# VERSIONS:
#   target version name of debian
# ARCHS:
#   target architecture name
# ALL_DISTRO:
#   all the distroseries name of debian that is obtained from "meta-release"
#

# Base directory of repository
BASE_DIR=/home/openrtm/public_html/pub/Linux/debian
DEFAULT_ARCHS="i386 amd64 armhf"
#DEBUG="TRUE"
...
get_distroseries()
{
    REL_URL=http://changelogs.debian.com/meta-release
...
print_usage()
{
    ...
    echo ""
    echo "    $(basename $0) /home/openrtm/public_html/pub/Linux/debian"
    echo ""
    echo "  Update only supported distro version's package DB."
    echo ""
    echo "    $(basename $0) -s /home/openrtm/public_html/pub/Linux/debian"
    echo ""
    echo "  Update only specified distro's pacakge DB."
    echo ""
    echo "    $(basename $0) -d precise ~openrtm/public_html/pub/Linux/debian"
    echo ""
    exit 0
}
